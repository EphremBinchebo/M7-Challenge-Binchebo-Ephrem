...
public class AlbumServiceLayerTest {
    ...
    @Test
    public void deleteAlbumShouldDeleteAlbumById() {
        AlbumViewModel avm = new AlbumViewModel();
        ...
        verify(albumRepository).deleteById(avm.getId());
    }

    @Test
    public void updateAlbumShouldUpdateAlbum() {
        AlbumViewModel avm = new AlbumViewModel();
        ...
        verify(albumRepository, times(2)).save(any(Album.class));
    }

    @Test
    public void failToUpdateAlbumWithBadId() {
        AlbumViewModel avm = new AlbumViewModel();
        ...
        avm.setTitle("The world");
        avm.setId(avm.getId() + 1);
        service.updateAlbum(avm);
    }
}
